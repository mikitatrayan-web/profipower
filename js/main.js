...
const TRANSLATIONS = {
  ua: {
    ...
    hero_title:       'НАВЧАННЯ ЗВАРЮВАЛЬНИКА З НУЛЯ ДО РОБОТИ',
    hero_sub:         'Міжнародна сертифікація TÜV Rheinland · ISO 9606 · Пропонуємо працевлаштування на заводах Польщі',
    ...
    prog1_title:      'MIG/MAG зварювання (135, 136)',
    prog1_duration:   '3 тижні',
    ...
    prog1_li2:        'Максимум практики на апаратах ESAB',
    ...
    step2_title:      'Навчайтесь на практиці',
    step2_desc:       'Максимум практики на обладнанні ESAB з досвідченими інструкторами. Індивідуальний підхід.',
    step3_title:      'Отримайте сертифікат',
    ...
    faq3_a:           'Ми навчаємо методам 135 та 136 (MIG/MAG) і 141 (TIG). Це найзатребуваніші методи на виробничих підприємствах Польщі.',
    ...
    prog_select_1:    'MIG/MAG (135, 136) — 3 тижні',
    ...
    office2_city:     'Бидгощ',
    office2_addr:     'Zielona 27, 33-300 Nowy Sącz, Polska',
    ...
    ben1:  'Офіційне працевлаштування на умовах зленця',
    ben2:  'Сплата всіх податків (страхування, ЗУС, ПІТ 11)',
    ben3:  'Виплата до 10-го числа щомісяця без затримок',
    ben4:  'Інструмент та одяг за рахунок фірми',
    ben5:  'Медогляд за рахунок працівника',
    ben6:  'Повний супровід на заводі до виходу на роботу',
    ben7:  'Документи легального працевлаштування для карти побиту',
    ben8:  'Житло за необхідності (платне)',
    ben9:  'Підключення рідних до страхового полісу',
    ben10: 'Безкоштовна перевірка кваліфікації для зварювальників та слюсарів',
    ben11: 'Курс донавчання читання технічних малюнків (монтер, механік, електромонтер, слюсар)',
  },
  ...
  en: {
    ...
    hero_title:       'WELDER TRAINING FROM ZERO TO WORK',
    hero_sub:         'International certification TÜV Rheinland · ISO 9606 · Employment guarantee at Polish factories',
    ...
    prog1_title:      'MIG/MAG welding (135, 136)',
    prog1_duration:   '3 weeks',
    ...
    prog1_li2:        'Maximum practice on ESAB equipment',
    ...
    step2_title:      'Learn in practice',
    step2_desc:       'Maximum practice on ESAB equipment with experienced instructors. Individual approach.',
    step3_title:      'Get your certificate',
    ...
    faq3_a:           'We teach methods 135 and 136 (MIG/MAG) and 141 (TIG). These are the most in-demand methods at Polish production plants.',
    ...
    prog_select_1:    'MIG/MAG (135, 136) — 3 weeks',
  ...
  pl: {
    ...
    hero_title:       'SZKOLENIE SPAWACZA OD ZERA DO PRACY',
    hero_sub:         'Certyfikacja międzynarodowa TÜV Rheinland · ISO 9606 · Gwarancja zatrudnienia w zakładach w Polsce',
    ...
    prog1_title:      'Spawanie MIG/MAG (135, 136)',
    prog1_duration:   '3 tygodnie',
    ...
    prog1_li2:        'Maksimum praktyki na urządzeniach ESAB',
    ...
    step2_title:      'Ucz się w praktyce',
    step2_desc:       'Maksimum praktyki na sprzęcie ESAB z doświadczonymi instruktorami. Indywidualne podejście.',
    step3_title:      'Odbierz certyfikat',
    ...
    faq3_a:           'Uczymy metod 135 i 136 (MIG/MAG) oraz 141 (TIG). To najpopularniejsze metody w polskich zakładach produkcyjnych.',
    ...
    prog_select_1:    'MIG/MAG (135, 136) — 3 tygodnie',
