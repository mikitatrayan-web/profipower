...
const TRANSLATIONS = {
  ua: {
    ...
    prog1_result:     'з нуля',
    prog1_desc:       'Повний курс зварювання методом 135/136/138. Від базових навичок до першого робочого місця на заводах Польщі.',
    prog1_li1:        'Базова теорія та техніка безпеки',
    ...
    step3_desc:       'Складіть іспит та отримайте сертифікат ISO 9606, TÜV Rheinland. Дійсний 3 роки по всій Європі.',
    ...
    faq_label:        'Маєте питання?',
    faq_title:        'Залишились питання?',
    faq_sub:          'Зв\'яжіться з нами зручним способом — відповімо швидко.',
  ...
  en: {
    ...
    faq_label:        'Have a question?',
    faq_title:        'Still have questions?',
    faq_sub:          'Contact us in any way convenient — we\'ll reply quickly.',
  ...
  pl: {
    ...
    faq_label:        'Masz pytanie?',
    faq_title:        'Zostały pytania?',
    faq_sub:          'Skontaktuj się z nami w wygodny sposób — odpowiemy szybko.',
