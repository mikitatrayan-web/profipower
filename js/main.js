...
const TRANSLATIONS = {
  ua: {
    ...
    hero_eyebrow:     'Школа зварників · Бидгощ, Польща',
    hero_title:       'НАВЧАННЯ ЗВАРНИКА З НУЛЯ ДО РОБОТИ',
    hero_sub:         'Міжнародна сертифікація TÜV Rheinland · ISO 9606 · Гарантія працевлаштування на заводах Польщі',
    ...
    why1_desc:        'Ми сертифікуємо зварників за міжнародним стандартом ISO 9606. Ваш сертифікат визнається по всій Європі та дійсний 3 роки.',
    ...
    why3_desc:        'Наші інструктори — практикуючі зварники з багаторічним виробничим досвідом. Не теорія, а реальна практика.',
    ...
    why5_title:       'Гарантія працевлаштування',
    ...
    guar_title:       'Гарантія працевлаштування',
