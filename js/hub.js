...
const HUB_TRANSLATIONS = {
  ua: {
    ...
    dir1_title:    'Навчання',
    dir1_desc:     'Курси зварювання, малярства та читання технічних креслень. Навчаємо з нуля.',
    ...
    edu4_desc:     'Інтенсивна підготовка до кваліфікаційного іспиту, практичне тестування та відпрацювання навичок відповідно до вимог підприємства за запитом кандидата.',
    edu4_tag:      '2 дні',
    ...
    empl_p2:       'Переїзд та адаптація',
    empl_p2d:      'Допомагаємо з оформленням документів та забезпечуємо житлом за потреби',
    empl_p3:       'Вхідний контроль та медогляд',
    empl_p3d:      'Супровід під час проходження вхідного контролю, організація медогляду та підтримка протягом усього періоду співпраці',
  ...
  en: {
    ...
    dir1_title:    'Training',
    dir1_desc:     'Welding, painting and technical drawing courses. We train from scratch.',
    dir1_cta:      'Learn more',
    ...
    edu4_desc:     'Intensive preparation for the qualification exam, practical testing and skills practice in line with company requirements — on candidate request.',
    edu4_tag:      '2 days',
    ...
    empl_p2:       'Relocation & adaptation',
    empl_p2d:      'We assist with document processing and provide housing if needed',
    empl_p3:       'Entry control & medical check',
    empl_p3d:      'Support during the entry control process, medical check organisation and ongoing support throughout the entire cooperation period',
  ...
  pl: {
    ...
    dir1_desc:     'Kursy spawania, malarstwa i czytania rysunków technicznych. Uczymy od zera.',
    ...
    edu4_desc:     'Intensywne przygotowanie do egzaminu kwalifikacyjnego, testy praktyczne i doskonalenie umiejętności zgodnie z wymaganiami zakładu — na wniosek kandydata.',
    edu4_tag:      '2 dni',
    ...
    empl_p2:       'Przeprowadzka i adaptacja',
    empl_p2d:      'Pomagamy z załatwieniem dokumentów i zapewniamy mieszkanie w razie potrzeby',
    empl_p3:       'Kontrola wstępna i badania',
    empl_p3d:      'Wsparcie podczas kontroli wstępnej, organizacja badań lekarskich i opieka przez cały okres współpracy',
    ...
    empl_b2:       'Opłacanie wszystkich podatków',
