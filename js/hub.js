...
const HUB_TRANSLATIONS = {
  ua: {
    ...
    edu4_desc:     'Інтенсивний курс для проходження заводського іспиту. Практичні тести.',
    edu4_tag:      '2 дні',
  ...
  en: {
    ...
    edu4_desc:     'Intensive course for factory entry exam. Practical tests.',
    edu4_tag:      '2 days',
  ...
  pl: {
    ...
    edu4_desc:     'Intensywny kurs do egzaminu wstępnego zakładu. Testy praktyczne.',
    edu4_tag:      '2 dni',
